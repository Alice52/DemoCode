...
public class JMSConsumerFromQueueRedelivery {
    private static final Logger LOGGER = LoggerFactory.getLogger(JMSConsumerFromQueueRedelivery.class);
        ...
        Optional.ofNullable(message)
                .ifPresent(
                        mg -> {
                            ...
                            try {
                                LOGGER.info("Consume message {} from queue {} success.", textMessage.getText(), QUEUE_NAME);
