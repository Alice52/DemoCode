 ...
 * BeanPostProcessor
 *
 * <p>populateBean(beanName, mbd, instanceWrapper); // set value of bean initializeBean {
 * applyBeanPostProcessorsBeforeInitialization(wrappedBean, beanName); invokeInitMethods(beanName,
 * wrappedBean, mbd); // execute custom init applyBeanPostProcessorsAfterInitialization(wrappedBean,
 * beanName); }
 *
 * @author zack <br>
