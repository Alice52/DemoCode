package cn.edu.ntu.javaee.spring.common.utils;
    ...
    public static Logger getTargetLogger(Logger LOGGER, JoinPoint joinPoint) {
        ...
        if (isDefaultLogger && !Constants.STRING_EMPTY.equals(LogFiled)) {
            ...
            try {
                ...
                LOGGER.warn(
                        "Get LogFiled[{}] from target ERROR[NoSuchFieldException], message {}",
                        LogFiled,
                        e);
            } catch (IllegalAccessException e) {
                LOGGER.warn(
                        "Get LogFiled[{}] from target ERROR[IllegalAccessException], message {}",
                        LogFiled,
                        e);
            }
