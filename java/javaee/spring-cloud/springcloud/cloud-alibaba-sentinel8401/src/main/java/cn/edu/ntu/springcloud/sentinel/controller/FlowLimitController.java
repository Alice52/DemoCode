 ...
 * - if sentinel guideline in UI is challenged, sentinel default handler will work to response
 * default limit string<br>
 * - only has block<br>
 * - if not challenge sentinel guideline in UI, everything is fine<br>
...
public class FlowLimitController {
    ...
    /**
     * exceptionsToIgnore = {NullPointerException.class} to ignore the exception, donot use fallback
     * <br>
