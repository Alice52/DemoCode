package cn.edu.ntu.java.javase.enumeration;

import cn.edu.ntu.java.javase.enumeration.constants.ErrorConstants;
import cn.edu.ntu.java.javase.enumeration.enumeration.EnumErrorCode;
...
public class ErrorCodeTest {
    ...
    public void testValueOf() {
        EnumErrorCode unexpected_exception =
                Enum.valueOf(EnumErrorCode.class, "UNEXPECTED_EXCEPTION");
        LOG.info(unexpected_exception.toString());

        EnumErrorCode enumErrorCode =
                EnumErrorCode.valueOf(EnumErrorCode.UNEXPECTED_EXCEPTION.name());
