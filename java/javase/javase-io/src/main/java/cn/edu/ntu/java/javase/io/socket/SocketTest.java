 ...
 * 1.IP和端口号的具体意思： <br>
 * 1.1IP定位网络中的一台主机 <br>
 * 1.2端口号定位主机的一个网络程序 <br>
 * 2.InetAddress：对象表示网络中的一个地址 <br>
 * 2.1InetAddress address=InetAddress.getByName("127.0.01"); <br>
 * 3.TCP/IP编程： <br>
 * 3.1服务器/客户端：客户端发送请求到服务器，服务器接受请求，给予响应到客户端 <br>
 * 3.2ServerSocket <br>
 */

/**
 * Socket1测试的是打印字符串 <br>
 * Socket2测试的是文件：带缓冲流 <br>
 * Socket2测试的是图片：不带缓冲流 <br>
 */
