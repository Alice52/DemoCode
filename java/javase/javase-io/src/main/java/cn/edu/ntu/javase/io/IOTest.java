...
/**
 * @author zack <br>
 * @create 2020-04-04 23:22 <br>
 */

/**
 * @author zack
 * @create 2019-06-10 14:05
 * @function: 测试IO流： 1.基本知识：中文乱码 2.文件复制
 */
public class IOTest {
    ...
    /**
     * 测试 InputStream： <br>
     * 1. FileInputStream 读取中文会出现中文乱码：使用 Reader 解决 <br>
     * Reader reader=new InputStreamReader(inputStream,"UTF-8"); <br>
     * 2. 2种方式： <br>
     * 逐个字节读取: .read() <br>
     * 一次读取一组数据: .read(b) <br>
     *
    ...
    public void testInputStream() throws Exception {
        ...
        // 从10开始放，一直放到了38的位置结束
        int end = inputStream.read(b2, 10, inputStream.available());
    ...
    @Test
    /**
     * 功能：测试 OutputStream 抽象类： <br>
     * 1.写入String字符串： <br>
     * outputStream.write(content.getBytes()); <br>
     * 2.逐字节的写入: 乱码了解决 <br>
     */
