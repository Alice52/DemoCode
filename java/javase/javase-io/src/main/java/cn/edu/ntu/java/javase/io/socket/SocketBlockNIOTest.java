package cn.edu.ntu.java.javase.io.socket;
...
/**
 * @author zack <br>
 * @create 2020-04-04 23:26 <br>
 */
public class SocketBlockNIOTest {
    ...
    public void server() throws IOException {
        ...
        // 2. Binds the channel's socket to a local address and configures the socket to listen for
        // connections.
