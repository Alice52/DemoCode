...
/**
 * 反射中封装的函数: 1.获取 methodName 方法, 该方法可能是私有的, 也可能是父类的(私有)方法: getMethod(Class<?> clazz, String
 * methodName, Class<?>...paramerTypes) 2.执行方法: *invoke2(String className,String methodName,
 * Object...args) *invoke(Object obj,String methodName, Object...args) 3.获取定义Class时声明的父类的泛型参数的类型:
